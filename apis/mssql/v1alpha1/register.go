...
// Execute type metadata.
var (
	ExecuteKind             = reflect.TypeOf(Execute{}).Name()
	ExecuteGroupKind        = schema.GroupKind{Group: Group, Kind: ExecuteKind}.String()
	ExecuteKindAPIVersion   = ExecuteKind + "." + SchemeGroupVersion.String()
	ExecuteGroupVersionKind = SchemeGroupVersion.WithKind(ExecuteKind)
)
